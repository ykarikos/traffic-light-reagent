...
if((i < len)){
var k = (ks[i]);
var G__26317 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__26318 = (i + (1));
m = G__26317;
i = G__26318;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__26319 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__26319) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__26319));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26321 = c;
var G__26321__$1 = (((G__26321 == null))?null:G__26321.prototype);
if((G__26321__$1 == null)){
return null;
} else {
return (G__26321__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26323 = c;
var G__26323__$1 = (((G__26323 == null))?null:G__26323.prototype);
if((G__26323__$1 == null)){
return null;
} else {
return (G__26323__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__26327__delegate = function (args){
var G__26325 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__26325) : reagent.impl.component.as_element.call(null,G__26325));
};
var G__26327 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__26328__i = 0, G__26328__a = new Array(arguments.length -  0);
while (G__26328__i < G__26328__a.length) {G__26328__a[G__26328__i] = arguments[G__26328__i + 0]; ++G__26328__i;}
  args = new cljs.core.IndexedSeq(G__26328__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26329);
...
var _STAR_current_component_STAR__orig_val__26331 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26332 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26332;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26331;
}});
...
return ((function (G__26333,G__26333__$1){
...
var c = this;
var G__26338_26340 = (c["cljsRatom"]);
if((G__26338_26340 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26338_26340);
}
...
var renders_26342 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_26343 = cljs.core.first(cljs.core.vals(renders_26342));
if((cljs.core.count(renders_26342) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26342))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26343)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26343], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__26341 = name;
switch (G__26341) {
case "":
...
var G__26346 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__26346) : reagent.impl.component.global$module$create_react_class.call(null,G__26346));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__26347 = fiber;
var G__26347__$1 = (((G__26347 == null))?null:(G__26347["type"]));
if((G__26347__$1 == null)){
return null;
} else {
return (G__26347__$1["displayName"]);
}
})();
var parent = (function (){var G__26348 = fiber;
if((G__26348 == null)){
return null;
} else {
return (G__26348["return"]);
}
})();
var path = (function (){var G__26349 = parent;
var G__26349__$1 = (((G__26349 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__26349) : reagent.impl.component.fiber_component_path.call(null,G__26349)));
if((G__26349__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26349__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__26351 = c;
if((G__26351 == null)){
return null;
} else {
return (G__26351["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__26352._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__26354 = c;
if((G__26354 == null)){
return null;
} else {
return (G__26354["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__26356 = c;
if((G__26356 == null)){
return null;
} else {
return G__26356._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__26358 = instance;
if((G__26358 == null)){
return null;
} else {
return (G__26358["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__26359 = instance;
if((G__26359 == null)){
return null;
} else {
return G__26359._currentElement;
}
}
})();
var name = (function (){var G__26360 = elem;
var G__26360__$1 = (((G__26360 == null))?null:(G__26360["type"]));
if((G__26360__$1 == null)){
return null;
} else {
return (G__26360__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__26362 = elem;
if((G__26362 == null)){
return null;
} else {
return (G__26362["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__26363._owner;
}
}
})();
var path = (function (){var G__26364 = owner;
var G__26364__$1 = (((G__26364 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__26364) : reagent.impl.component.component_path.call(null,G__26364)));
if((G__26364__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26364__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__26365 = c;
var G__26365__$1 = (((G__26365 == null))?null:G__26365.constructor);
if((G__26365__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__26365__$1);
}
}
})();
