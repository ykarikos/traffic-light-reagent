...
var G__26385 = o;
(G__26385[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26386__delegate = function (args){
...
return G__26386__delegate.call(this,args);};
...
return G__26386__delegate(args);
});
...
var G__26389 = o;
(G__26389[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__26394 = props;
var G__26394__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26394,cljs.core.cst$kw$id,id):G__26394);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26394__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26395){
...
var props = map__26396__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26396__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__26396,map__26396__$1,props,class$){
return (function (c){
...
});})(map__26396,map__26396__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26398){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26399__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__26399,map__26399__$1,on_write){
return (function (){
...
});})(node_value,map__26399,map__26399__$1,on_write))
);
} else {
...
var G__26402 = jsprops;
(G__26402["defaultValue"] = value);

(G__26402["onChange"] = ((function (G__26402,v,value,on_change){
return (function (p1__26401_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26401_SHARP_);
});})(G__26402,v,value,on_change))
);
...
var vec__26405 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26405,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26405,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26405,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___26409 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___26409 == null)){
} else {
var key_26410 = temp__5724__auto___26409;
(jsprops["key"] = key_26410);
}
...
var temp__5724__auto___26411 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___26411 == null)){
} else {
var key_26412 = temp__5724__auto___26411;
reagent.impl.template.oset(jsprops,"key",key_26412);
}
...
var G__26413 = reagent.impl.template.__GT_NativeWrapper();
(G__26413["name"] = c);
...
var G__26414 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26414) : reagent.impl.template.as_element.call(null,G__26414));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26418){
var G__26419 = cljs.core.first(seq26418);
var seq26418__$1 = cljs.core.next(seq26418);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26419,seq26418__$1);
});
...
break;
default:
var G__26425 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26425;
continue;
...
var n__4607__auto___26427 = a.length;
var i_26428 = (0);
while(true){
if((i_26428 < n__4607__auto___26427)){
(a[i_26428] = reagent.impl.template.as_element((a[i_26428])));

var G__26429 = (i_26428 + (1));
i_26428 = G__26429;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___26430 = a.length;
var i_26431 = (0);
while(true){
if((i_26431 < n__4607__auto___26430)){
var val_26432 = (a[i_26431]);
if(((cljs.core.vector_QMARK_(val_26432)) && ((reagent.impl.template.key_from_vec(val_26432) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26431] = reagent.impl.template.as_element(val_26432));
...
var ctx = ({});
var vec__26434 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26434,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26434,(1),null);
...
var G__26437 = (cljs.core.count(argv) - first_child);
switch (G__26437) {
case (0):
...
case (1):
var G__26438 = comp;
var G__26439 = jsprops;
var G__26440 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__26438,G__26439,G__26440) : reagent.impl.template.global$module$react.createElement.call(null,G__26438,G__26439,G__26440));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__26437){
